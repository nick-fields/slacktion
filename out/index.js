...
Object.defineProperty(exports, "__esModule", { value: true });
var slacktion_1 = __webpack_require__(352);
var core_1 = __webpack_require__(470);
var opts = {
    slackBotToken: (0, core_1.getInput)("slack_bot_token"),
    jobStatus: (0, core_1.getInput)("job_status"),
    channel: (0, core_1.getInput)("channel"),
    text: (0, core_1.getInput)("text"),
    icon_url: (0, core_1.getInput)("icon_url"),
    pretext: (0, core_1.getInput)("pretext"),
    title: (0, core_1.getInput)("title"),
    title_url: (0, core_1.getInput)("title_url"),
    image_url: (0, core_1.getInput)("image_url"),
    footer: (0, core_1.getInput)("footer"),
    footer_icon_url: (0, core_1.getInput)("footer_icon_url"),
    fields: (0, core_1.getInput)("fields"),
    buttons: (0, core_1.getInput)("buttons"),
};
(0, slacktion_1.runAction)(opts)
    .then(function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.runAction = exports.statusColor = void 0;
var axios_1 = __importDefault(__webpack_require__(53));
var url_1 = __webpack_require__(835);
var POST_MESSAGE_PATH = "/api/chat.postMessage";
var JOIN_CONVERSATION_PATH = "/api/conversations.join";
var LIST_CHANNELS_PATH = "/api/conversations.list";
...
function getChannel(name, token) {
    return __awaiter(this, void 0, void 0, function () {
        var cursor, query, path, resp, channel;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    path = LIST_CHANNELS_PATH + "?" + query;
                    return [4 /*yield*/, request(token, path, undefined, "GET", "application/x-www-form-urlencoded")];
                case 2:
                    resp = _a.sent();
                    cursor = resp.data.response_metadata.next_cursor;
                    channel = resp.data.channels.find(function (c) { return c.name === name; });
                    if (channel) {
...
function joinChannel(channel, token) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getChannel(channel, token)];
                case 1:
                    conversation = _a.sent();
                    if (!conversation) return [3 /*break*/, 3];
                    return [4 /*yield*/, request(token, JOIN_CONVERSATION_PATH, { channel: conversation.id }, "POST")];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
...
function request(token, path, body, method, contentType) {
...
function runAction(opts) {
    return __awaiter(this, void 0, void 0, function () {
        var fields, actions, body, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 3, , 8]);
                    return [4 /*yield*/, request(opts.slackBotToken, POST_MESSAGE_PATH, body, "POST")];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 8];
                case 3:
                    error_1 = _a.sent();
                    if (!error_1.includes("not_in_channel")) return [3 /*break*/, 6];
                    return [4 /*yield*/, joinChannel(body.channel, opts.slackBotToken)];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, request(opts.slackBotToken, POST_MESSAGE_PATH, body, "POST")];
                case 5:
                    ...
                    return [3 /*break*/, 7];
                case 6:
                    console.error("Slack API returned the error: " + error_1);
                    process.exit(1);
                    _a.label = 7;
